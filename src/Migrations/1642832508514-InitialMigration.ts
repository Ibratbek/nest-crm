...
export class InitialMigration1642832508514 implements MigrationInterface {
  name = "InitialMigration1642832508514";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "marks" ("id" SERIAL NOT NULL, "date" TIMESTAMP NOT NULL DEFAULT now(), "mark" integer NOT NULL, "student_id" integer, "subject_id" integer, CONSTRAINT "REL_5226e1592e6291dbe7a0764034" UNIQUE ("student_id"), CONSTRAINT "REL_13120386acf0b80ecd25fdac3b" UNIQUE ("subject_id"), CONSTRAINT "PK_051deeb008f7449216d568872c6" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
